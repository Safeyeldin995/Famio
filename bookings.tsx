export type Category = "home" | "kids";
...
export const providers: Provider[] = [
  {
    ...
    badges: ["ID Verified", "Background Check", "Famio Certified"], trustScore: 98, gender: "Female",
  ...
  },
  {
    ...
    badges: ["ID Verified", "Background Check", "Famio Certified", "Top Rated"], trustScore: 99, gender: "Female",
  ...
  },
  {
    ...
    languages: ["Arabic", "English"], areas: ["Sheikh Zayed", "6th of October"],
    badges: ["ID Verified", "Background Check", "First Aid", "Famio Certified"], trustScore: 99, gender: "Female",
...
export const offers = [
  { id: "o1", title: "20% off your first booking", subtitle: "Welcome to Famio", code: "FAMIO20", gradient: "from-navy to-[#2d4ba8]" },
...
export const mockBookings = [
  ...
  },
  {
    id: "FM-1987",
    providerId: "k1",
    service: "Famio Kids — Babysitting",
    date: "Last Friday",
    time: "7:00 PM",
    duration: "4h",
...
export const mockMessages = [
  { id: "m1", providerId: "p1", lastMessage: "I'll be there at 10 sharp 🙌", time: "9:42 AM", unread: 1 },
  { id: "m2", providerId: "k1", lastMessage: "Thank you! See you Friday.", time: "Yesterday", unread: 0 },
  { id: "m3", providerId: "p3", lastMessage: "All cleaned. Hope you love it!", time: "Mon", unread: 0 },
];

export const mockChat: Record<string, { id: string; from: "me" | "them"; text: string; time: string }[]> = {
  m1: [
    { id: "1", from: "them", text: "Hi Sarah! Confirming our visit tomorrow at 10am.", time: "9:30 AM" },
    { id: "2", from: "me", text: "Yes please. The doorman has the key.", time: "9:35 AM" },
    { id: "3", from: "them", text: "Perfect. I'll be there at 10 sharp 🙌", time: "9:42 AM" },
  ],
};
...
export const mockNotifications = [
  ...
  { id: "n2", title: "20% off your next clean", body: "Use code FAMIO20 at checkout.", time: "2h ago", type: "offer", unread: true },
